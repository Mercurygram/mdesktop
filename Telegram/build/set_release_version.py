...
# AppVersionOriginal stays purely numeric (X.Y.Z.N). Upstream encodes betas as a
# 3-part "X.Y.Z.beta", but our 4-part scheme would make it "X.Y.Z.N.beta", which
# cmake/version.cmake misparses (counter read as the beta token). The beta channel
# is carried by the tag's -beta suffix -> BetaChannel / AppBetaVersion instead.
versionOriginal = versionStr
