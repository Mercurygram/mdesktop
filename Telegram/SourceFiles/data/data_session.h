...
private:
	...
	// Once a second while a secret-chat message has a running self-destruct
	// timer: re-lays its bottom info so the countdown text advances.
	base::Timer _ttlCountdownTimer;
